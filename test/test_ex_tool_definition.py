...
class ToolDefinitionAmbiguityTest(tools_for_test.TemporaryDirectoryTestCase):

    # noinspection PyAbstractClass
    def test_location_of_tools_are_correct(self):
        lineno = 387  # of this line
...
class ToolInstanceConstructionTest(unittest.TestCase):
    ...
    def test_dependencies_are_assigned(self):
        ...
        self.assertIsInstance(ToolInstanceConstructionTest.DTool.source_file, Tool.Input)
        self.assertIsInstance(ToolInstanceConstructionTest.DTool.object_file, Tool.Output)
        self.assertIsInstance(ToolInstanceConstructionTest.DTool.include_directories, Tool.Input)
        self.assertIsInstance(ToolInstanceConstructionTest.DTool.map_file, Tool.Output)
